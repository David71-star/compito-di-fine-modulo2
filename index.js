...
// PARTE 1 ESERCIZIO DI FINE MODULO

// const cercaLEP = function (title, location) {
//   for (let i = 0; i < jobs.length; i++) {
//     if (
//       jobs[i].title.toLocaleLowerCase().includes(title.toLocaleLowerCase()) &&
//       jobs[i].location
//         .toLocaleLowerCase()
//         .includes(location.toLocaleLowerCase())
//     ) {
//       let listWork = "";
//       listWork += jobs[i].title + ": " + jobs[i].location;
//       work.push(listWork);
//     }
//   }
//   return work.join("  ");
// };
// const work = [];
// let risultato = cercaLEP("marketing", "Us");

// console.log("result: " + risultato);
// console.log("count: " + work.length);

// PARTE 2 ESERCIZIO DI FINE MODULO
